...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"./pkg/apis/snapscheduler/v1.SnapshotRetentionSpec":  schema_pkg_apis_snapscheduler_v1_SnapshotRetentionSpec(ref),
		"./pkg/apis/snapscheduler/v1.SnapshotSchedule":       schema_pkg_apis_snapscheduler_v1_SnapshotSchedule(ref),
		"./pkg/apis/snapscheduler/v1.SnapshotScheduleSpec":   schema_pkg_apis_snapscheduler_v1_SnapshotScheduleSpec(ref),
		"./pkg/apis/snapscheduler/v1.SnapshotScheduleStatus": schema_pkg_apis_snapscheduler_v1_SnapshotScheduleStatus(ref),
		"./pkg/apis/snapscheduler/v1.SnapshotTemplateSpec":   schema_pkg_apis_snapscheduler_v1_SnapshotTemplateSpec(ref),
	}
}

func schema_pkg_apis_snapscheduler_v1_SnapshotRetentionSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_pkg_apis_snapscheduler_v1_SnapshotSchedule(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/snapscheduler/v1.SnapshotScheduleSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/snapscheduler/v1.SnapshotScheduleStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./pkg/apis/snapscheduler/v1.SnapshotScheduleSpec", "./pkg/apis/snapscheduler/v1.SnapshotScheduleStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_snapscheduler_v1_SnapshotScheduleSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"retention": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("./pkg/apis/snapscheduler/v1.SnapshotRetentionSpec"),
						},
					},
					"schedule": {
						SchemaProps: spec.SchemaProps{
					...
					"snapshotTemplate": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("./pkg/apis/snapscheduler/v1.SnapshotTemplateSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./pkg/apis/snapscheduler/v1.SnapshotRetentionSpec", "./pkg/apis/snapscheduler/v1.SnapshotTemplateSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.LabelSelector"},
	}
}

func schema_pkg_apis_snapscheduler_v1_SnapshotScheduleStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_snapscheduler_v1_SnapshotTemplateSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
